  ...
  return (
    <>
      <div className=" static bottom-0 flex flex-col-reverse md:flex-row md:justify-between justify-center w-screen h-auto bg-[#850E35]">
        <div className="flex flex-col justify-evenly items-center md:w-[30%]">
          ...
          <div className="inline-flex gap-4 p-4 md:gap-5">
            ...
            <AiFillLinkedin
              size={`${window.screen.innerwidth > 950 ? 64 : 64}`}
              color={"white"}
            />
            <AiOutlineInstagram
              size={`${window.screen.innerwidth > 950 ? 64 : 64}`}
          ...
          <div>
            <span className="font-Mplus md:text-[24px] text-[16px] font-bold text-white hidden md:flex">
              Mail US:{" "}
              <a
        ...
        <div className="md:w-[40%] w-screen flex jsutify-center flex-col text-white mx-8 py-4 md:mx-4">
          <h2 className="md:text-[30px] text-[24px] py-4 self-center font-Mplus font-bold">
            CONTACT US
          </h2>
          <span className="text-[16px] md:text-xl font-Mplus font-extrabold">
      ...
      <div className="flex justify-center align-center bg-[#850E35] text-white">
        <span className="p-2 font-bold text-[12px] md:text-xl font-Mplus">
