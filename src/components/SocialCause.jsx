...
import dog from "/src/assets/socialCause/feedDog.jpg"
    ...
    <>
      <div className="w-full min-h-screen h-auto bg-[#FFF5E4]">
        ...
        <section className="w-screen h-auto px-8 pt-24 md:m-0">
          ...
          <img src={dog} alt="IKSHANA IMG" className='w-[40vw] h-auto aspect-video object-cover rounded-xl mx-auto' />
